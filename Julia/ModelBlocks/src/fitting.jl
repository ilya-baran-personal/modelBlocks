...
function fitParameters(block::BlockWithOutputs, timeRange::AbstractRange, expectedOutputs::Variables; kwargs...)
...
function fitParameters(block::BlockWithOutputs, timeRange::AbstractRange,
                       parametersAndBounds::AbstractDict{String, Tuple{Float64, Float64}}, expectedOutputs::Variables; kwargs...)
    ...
    return fitParameters(boundWithOutputs, timeRange, lower, upper, expectedOutputs; kwargs...);
end

function fitParameters(block::BlockWithOutputs, timeRange::AbstractRange, lower::Array, upper::Array, expectedOutputs::Variables; MaxTime = 10)
